...
export default function CraftbeerMe({ recommendation1, recommendation2, recommendation3 }) {
  ...
  const flavors1 = [
    'fruity', 'hoppy', 'spicy', 'pineapple', 'lychee', 'raspberry', 'apple', 'tart', 'tropical', 'mango',
    'tangerines', 'bitter', 'passionfruit', 'citrus', 'orange', 'grapefruit', 'coconut', 'guava'
  ];

  const flavors2 = [
    'chocolate', 'vanilla', 'cinnamon', 'caramel', 'cocoa', 'marshmallow', 'coffee', 'toffee', 'biscuits',
    'honey', 'bread', 'sour', 'woody', 'nutty', 'lime', 'pumpkin', 'cloves', 'floral', 'malty'
  ];
