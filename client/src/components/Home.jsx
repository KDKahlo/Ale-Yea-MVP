...
function Home() {
    ...
    <div className="carouselImages col-md-8 protest-strike-regular ">
        <div id="carouselExampleAutoplaying" className="carousel slide position-absolute top-50 start-0 translate-middle-y ">
